      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-slate-600 mt-6 max-w-xl mx-auto lg:mx-0 leading-8">
            ...
            that solve real-world problems using React, Node.js,
            Express and MongoDB.
          </p>
          ...
          <div className="flex justify-center lg:justify-start gap-3 sm:gap-4 mt-10 flex-wrap">
            ...
            <Link
              ...
              duration={600}
              offset={-80}
              className="cursor-pointer inline-flex items-center justify-center px-4 sm:px-8 py-3 sm:py-4 rounded-xl border border-slate-300 hover:bg-[#f14236] hover:text-white transition text-sm sm:text-base font-medium"
            >
